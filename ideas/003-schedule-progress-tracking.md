...
- A schedule view that turns each planned session into a task card.
- A task-board UI (GitHub-style) where sessions move to done.
- A progress heatmap that fills in as you show up.

## Notes

- **Metric:** weekly active loggers and board completion.
- **Risk:** over-building a task manager instead of a tracker — keep it read-focused.
