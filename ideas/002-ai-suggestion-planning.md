...
2. AI generates a routine with progression rules.
3. An evaluation guide checks in after a few sessions and regenerates based on
   real feedback and preferences.

## Notes

- Lead with a guided intake, not a blank prompt — quality depends on the questions.
- **Metric:** plan adoption and completion rate.
- **Risk:** generic-sounding output erodes trust faster than no feature.
