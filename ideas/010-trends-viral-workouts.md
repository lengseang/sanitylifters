...
- Daily pulls of trending fitness content (YouTube, TikTok, Instagram).
- An evaluation layer that surfaces the best into top tips.
- Influencer-recommended workout plans, tagged and searchable.
- Viral exercise categories by target muscle.

## Notes

- **Metric:** tips-to-saves and plan adoption.
- **Risk:** this is research-heavy — it needs social APIs or a VPS doing daily pulls,
  and may need AI for evaluation. Validate demand before building the pipeline.
