...
const CATEGORIES = ['overview', 'coach', 'train', 'engage', 'connect', 'content', 'monetize'];
...
function normalize(idea) {
  ...
  return {
    ...
    category: CATEGORIES.includes(idea.category) ? idea.category : null,
    priority: PRIORITIES.includes(idea.priority) ? idea.priority : null,
